...
lyr_Kota_BandungADMNew_1.set('fieldLabels', {'NAMOBJ': 'inline label - visible with data', 'REMARK': 'no label', 'LCODE': 'no label', 'WADMKC': 'inline label - visible with data', 'WADMKK': 'no label', 'WADMPR': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
